    ...
    <>
      ...
      <Box sx={{ textAlign: "left" }}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Pollee.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Pollee, accessible from{" "}
              <ControlLink to="/">https://pollee.com</ControlLink>.
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              methods not expressly permitted by Pollee.
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          ...
          If you choose to exercise this right, please inform Pollee that you
